            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1 class="heading-title">Tambah Kategori Pengaduan</h1>
                            <p class="mb-0">
                                Tambah kategori baru untuk klasifikasi pengaduan warga. Setiap kategori memiliki SLA dan prioritas penanganan.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="booking-wrapper">
                            ...
                            <div class="booking-header text-center" data-aos="fade-up" data-aos-delay="200">
                                <h2>Form Tambah Kategori Pengaduan</h2>
                                <p>Isi data kategori dengan lengkap untuk memudahkan klasifikasi dan penanganan pengaduan.</p>
                            </div>
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="number" name="sla_hari" class="form-control"
                                                ...
                                                value="{{ old('sla_hari') }}" min="1" max="30" required>
                                        ...
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn-book">Simpan Kategori</button>
                            ...
                            <div class="emergency-info text-center mt-4" data-aos="fade-up" data-aos-delay="400">
                                <p><i class="bi bi-info-circle"></i> Kategori yang ditambahkan akan langsung tersedia di form pengaduan warga.</p>
                            </div>
