            ...
            <div class="container">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-8">
                        ...
                        <p class="mb-0">
                            Kelola semua pengaduan yang telah diajukan oleh warga. Lihat, edit, atau tanggapi pengaduan dengan mudah.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="pengaduan-card">
                        <div class="pengaduan-header">
                            ...
                            <div class="pengaduan-overlay">
                                <div class="action-links">
                                    <a href="{{ route('pengaduan.show', $item->pengaduan_id) }}" class="btn-info" title="Lihat Detail">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('pengaduan.edit', $item->pengaduan_id) }}" class="btn-edit" title="Edit Data">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('pengaduan.destroy', $item->pengaduan_id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <div class="pengaduan-content">
                            ...
                            <div class="pengaduan-info">
                                <p><strong>Pengaju:</strong> {{ $item->warga->nama }}</p>
...
.btn-info:hover, .btn-edit:hover, .btn-delete:hover {
    transform: scale(1.1);
    color: white;
}
...
.btn-info-full, .btn-edit-full, .btn-delete-full {
    flex: 1;
    padding: 6px 12px;
    border: none;
    border-radius: 5px;
...
.btn-info-full:hover, .btn-edit-full:hover, .btn-delete-full:hover {
    opacity: 0.9;
